 ...
 * @author Rojeru San
 */
public class Lista_categorias extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Lista_categorias(JFrame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            String data[][] = {};
            String cabecera[] = {"Id de la Categoria", "Nombre de la categoría"};

            modelotablacategoria.setDataVector(data, cabecera);

            tablacategorias.setModel(modelotablacategoria);
            //this.setLocationRelativeTo(null);
            tablacategorias.getTableHeader().setDefaultRenderer(new EstiloTablaHeader());
            tablacategorias.setDefaultRenderer(Object.class, new EstiloTablaRenderer());
    ...
    private void initComponents() {
        ...
        tablacategorias.setBackground(new java.awt.Color(153, 184, 255));
        tablacategorias.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        tablacategorias.setDoubleBuffered(true);
        tablacategorias.setRowHeight(20);
        tablacategorias.setSelectionBackground(new java.awt.Color(0, 153, 255));
        ...
        getContentPane().add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 350));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lista_categorias dialog = new Lista_categorias(new javax.swing.JFrame(), true);
