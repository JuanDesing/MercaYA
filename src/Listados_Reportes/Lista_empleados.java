 ...
 * @author Rojeru San
 */
public class Lista_empleados extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Lista_empleados(JFrame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            String data[][] = {};
            String cabecera[] = {"Cédula empleado", "Nombre empleado", "Apellido empleado",
                "Dirección empleado", "Email empleado", "Teléfono empleado", "Fecha de ingreso"};

            modelotablacategoria.setDataVector(data, cabecera);

            tablaempleados.setModel(modelotablacategoria);
            //this.setLocationRelativeTo(null);
            tablaempleados.getTableHeader().setDefaultRenderer(new EstiloTablaHeader());
            tablaempleados.setDefaultRenderer(Object.class, new EstiloTablaRenderer());
            tablaempleados.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

            Conexion con = new Conexion();
            con.ConexionPostgres();

            ResultSet rs = con.consultar("SELECT * FROM empleado ORDER BY cedula_empleado");
    ...
    private void initComponents() {
        ...
        tablaempleados.setBackground(new java.awt.Color(153, 184, 255));
        ...
        tablaempleados.setDoubleBuffered(true);
        tablaempleados.setRowHeight(20);
        tablaempleados.setSelectionBackground(new java.awt.Color(0, 153, 255));
        ...
        titulo1.setText("Lista de empleados !");
        ...
        getContentPane().add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 995, 510));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lista_empleados dialog = new Lista_empleados(new javax.swing.JFrame(), true);
