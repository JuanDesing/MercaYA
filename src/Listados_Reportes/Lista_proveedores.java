 ...
 * @author Rojeru San
 */
public class Lista_proveedores extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Lista_proveedores(JFrame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            String data[][] = {};
            String cabecera[] = {"Nit proveedor", "Nombre proveedor", "Dirección del proveedor",
                "Email del proveedor", "Télefono proveedor"};

            modelotablacategoria.setDataVector(data, cabecera);

            listadeproveedores.setModel(modelotablacategoria);
            //this.setLocationRelativeTo(null);
            listadeproveedores.getTableHeader().setDefaultRenderer(new EstiloTablaHeader());
            listadeproveedores.setDefaultRenderer(Object.class, new EstiloTablaRenderer());
            listadeproveedores.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

            Conexion con = new Conexion();
            con.ConexionPostgres();

            ResultSet rs = con.consultar("SELECT * FROM proveedor ORDER BY nit_proveedor");
    ...
    private void initComponents() {
        ...
        listadeproveedores.setBackground(new java.awt.Color(153, 184, 255));
        listadeproveedores.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        listadeproveedores.setForeground(new java.awt.Color(255, 255, 255));
        listadeproveedores = new javax.swing.JTable(){
        ...
        listadeproveedores.setDoubleBuffered(true);
        listadeproveedores.setRowHeight(20);
        listadeproveedores.setSelectionBackground(new java.awt.Color(0, 153, 255));
        ...
        listadeproveedores.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                listadeproveedoresMouseClicked(evt);
            }
        });
    ...
    private void listadeproveedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listadeproveedoresMouseClicked

    }//GEN-LAST:event_listadeproveedoresMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lista_proveedores dialog = new Lista_proveedores(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JTable listadeproveedores;
