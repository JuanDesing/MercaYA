 ...
 * @author Rojeru San
 */
public class Lista_inventariogeneral extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Lista_inventariogeneral(JFrame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
            ...
            String data[][] = {};
            String cabecera[] = {"Id del producto", "Nombre producto", "Valor producto",
                "Existenia", "Stock Minimo", "Categoría", "Proveedor"};

            modelotablacategoria.setDataVector(data, cabecera);

            tablainventariogeneral.setModel(modelotablacategoria);
            //this.setLocationRelativeTo(null);
            tablainventariogeneral.getTableHeader().setDefaultRenderer(new EstiloTablaHeader());
            tablainventariogeneral.setDefaultRenderer(Object.class, new EstiloTablaRenderer());
            tablainventariogeneral.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

            Conexion con = new Conexion();
            con.ConexionPostgres();

            ResultSet rs = con.consultar("SELECT * FROM producto ORDER BY id_producto");
    ...
    private void initComponents() {
        ...
        tablainventariogeneral = new javax.swing.JTable();
        ...
        tablainventariogeneral.setBackground(new java.awt.Color(153, 184, 255));
        tablainventariogeneral.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tablainventariogeneral.setForeground(new java.awt.Color(255, 255, 255));
        tablainventariogeneral = new javax.swing.JTable(){
            public boolean isCellEditable(int rowIndex, int colIndex){
                return false;
            }
        };
        tablainventariogeneral.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablainventariogeneral.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tablainventariogeneral.setDoubleBuffered(true);
        tablainventariogeneral.setRowHeight(20);
        tablainventariogeneral.setSelectionBackground(new java.awt.Color(0, 153, 255));
        tablainventariogeneral.getTableHeader().setReorderingAllowed(false);
        tablainventariogeneral.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablainventariogeneralMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablainventariogeneral);

        titulo1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        titulo1.setForeground(new java.awt.Color(0, 51, 51));
        titulo1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        titulo1.setText("Inventario general !");
        ...
        getContentPane().add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 950, 510));
    ...
    private void tablainventariogeneralMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablainventariogeneralMouseClicked

    }//GEN-LAST:event_tablainventariogeneralMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lista_inventariogeneral dialog = new Lista_inventariogeneral(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JTable tablainventariogeneral;
