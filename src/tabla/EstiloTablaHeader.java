...
public class EstiloTablaHeader implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable jtable, Object value, boolean bln, boolean bln1, int row, int column) {
        ...
        jcomponent.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 0, 1, new java.awt.Color(53, 56, 69)));
        jcomponent.setOpaque(true);
        jcomponent.setBackground(new Color(134, 191, 163));
        jcomponent.setForeground(new Color(0, 51, 51));
