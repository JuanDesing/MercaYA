 ...
 * @author Rojeru San
 */
public class WarningAlertCerrar1 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WarningAlertCerrar1(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        titulo.setText("¿Estás seguro de que deseas ");

        aceptar.setBackground(new java.awt.Color(255, 66, 26));
        ...
        cancelar.setBackground(new java.awt.Color(255, 66, 26));
        ...
        titulo1.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        titulo1.setForeground(new java.awt.Color(153, 153, 153));
        titulo1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        titulo1.setText("cerrar el programa?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertCerrar1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertCerrar1 dialog = new WarningAlertCerrar1(new javax.swing.JFrame(), true);
