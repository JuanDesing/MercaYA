 ...
 * @author Rojeru San
 */
public class SuccessAlert1 extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SuccessAlert1(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SuccessAlert1 dialog = new SuccessAlert1(new javax.swing.JFrame(), true);
